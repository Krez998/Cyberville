...
public class GearBox : MonoBehaviour
{
    ...
    [SerializeField] private float _wheelAngleSpeed; // ������� �������� ������ �/�, ���./�

    [Header("MIN MAX")]
    [SerializeField] private float _wheelMinRotationSpeed;
    [SerializeField] private float _wheelMaxRotationSpeed; // �������� �������� ������ ����./���.
    ...
    {
        _speed = Mathf.Round(transform.InverseTransformDirection(_rigidbody.linearVelocity).z * 3.6f);
